...
fn to_payment_details(
    ...
    match &payment.kind {
        ldk_node::payment::PaymentKind::Bolt11 { hash, preimage, .. } => PaymentDetails::Ln {
            data: ln_payment_details(hash, preimage, destination_pubkey, false),
        },
        ldk_node::payment::PaymentKind::Bolt11Jit { hash, preimage, .. } => PaymentDetails::Ln {
            data: ln_payment_details(hash, preimage, destination_pubkey, false),
        },
        ...
        | ldk_node::payment::PaymentKind::Onchain { .. } => todo!(),
    }
}
